...
namespace RENDER_NAMESPACE {
    namespace scene {
        ...
        /*
        Float *SimpleScene::testSmokeData() {
        ...
        std::shared_ptr<Medium> SimpleScene::testAirMedium() {
...
//                sigmaA.b(0.014f);
        ...
        SimpleScene::testLeftWall(const Material material,
        ...
        std::vector<std::shared_ptr<Geometry>>
        SimpleScene::testRightWall(const Material material,
                             const std::shared_ptr<Medium> insideMedium,
                             const std::shared_ptr<Medium> outsideMedium) {
            const Vector3F a1(0.5 * MODEL_SCALE, 0.5 * MODEL_SCALE, -0.5 * MODEL_SCALE);
            const Vector3F a2(0.5 * MODEL_SCALE, 0.5 * MODEL_SCALE, 0.5 * MODEL_SCALE);
        ...
        std::vector<std::shared_ptr<Geometry>>
        SimpleScene::testBottomWall(const Material material,
                              const std::shared_ptr<Medium> insideMedium,
                              const std::shared_ptr<Medium> outsideMedium) {
            const Vector3F a1(0.5 * MODEL_SCALE, -0.5 * MODEL_SCALE, -0.5 * MODEL_SCALE);
            const Vector3F a2(-0.5 * MODEL_SCALE, -0.5 * MODEL_SCALE, -0.5 * MODEL_SCALE);
...
/*
        std::vector<std::shared_ptr<Geometry>>
        SimpleScene::testBottomPlane(const Material material,
                              const std::shared_ptr<Medium> insideMedium,
                              const std::shared_ptr<Medium> outsideMedium) {
        ...
        */
        ...
        std::vector<std::shared_ptr<Geometry>>
        SimpleScene::testTopAreaLight(const Spectrum spectrum, const std::shared_ptr<Medium> medium,
        ...
        std::vector<std::shared_ptr<Geometry>> SimpleScene::testTopWall(const Material material,
                                                                  const std::shared_ptr<Medium> insideMedium,
                                                                  const std::shared_ptr<Medium> outsideMedium) {
            const Vector3F a1(0.5 * MODEL_SCALE, 0.5 * MODEL_SCALE, -0.5 * MODEL_SCALE);
            const Vector3F a2(-0.5 * MODEL_SCALE, 0.5 * MODEL_SCALE, -0.5 * MODEL_SCALE);
        ...
        std::vector<std::shared_ptr<Geometry>>
        SimpleScene::testFrontWall(const Material material,
                             const std::shared_ptr<Medium> insideMedium,
                             const std::shared_ptr<Medium> outsideMedium) {
            const Vector3F a1(0.5 * MODEL_SCALE, 0.5 * MODEL_SCALE, -0.5 * MODEL_SCALE);
            const Vector3F a2(-0.5 * MODEL_SCALE, 0.5 * MODEL_SCALE, -0.5 * MODEL_SCALE);
...
/*
        std::shared_ptr<Aggregation> SimpleScene::testSubsurfaceBunny(const Material material,
        ...
        */
        std::shared_ptr<AreaLight> SimpleScene::testDiffuseAreaLight(const Spectrum &spectrum,
        ...
        std::shared_ptr<SimpleScene> SimpleScene::innerSceneWithAreaLight(MemoryAllocator &allocator) {
            // For testing
            // albedos
            // total white
            ...
            // build scene object
            std::shared_ptr<SimpleScene> scene = std::make_shared<SimpleScene>();
        ...
        std::shared_ptr<SimpleScene> SimpleScene::innerSceneWithPointLight(MemoryAllocator &allocator) {
            // For testing
            // albedos
            // total white
            Spectrum totalWhiteSpectrum = Spectrum(1.0);
...
//            std::shared_ptr<Medium> airMedium = testAirMedium();
        ...
        std::shared_ptr<SimpleScene> SimpleScene::innerSceneBunnyWithPointLight(MemoryAllocator &allocator) {
            // For testing
            // albedos
            // total white
            Spectrum totalWhiteSpectrum = Spectrum(1.0);
...
//            std::shared_ptr<Medium> airMedium = testAirMedium();
        ...
        /*
        std::shared_ptr<SimpleScene> SimpleScene::sceneBunnySubsurfaceWithAreaLight() {
            // For testing
            // albedos
            // total white
            Spectrum totalWhiteSpectrum = Spectrum(1.0);
...
//            std::shared_ptr<Intersectable> bunny = testBunny(nullptr, bunnyMedium, airMedium, nullptr);
        ...
        const std::vector<std::shared_ptr<EnvironmentLight>> &SimpleScene::getEnvironmentLights() const {
            return _envLights;
        }

        void SimpleScene::addEnvironmentLight(std::shared_ptr<EnvironmentLight> envLight) {
            ASSERT(envLight != nullptr, "Added env-light can't be nullptr. ")
            _envLights.push_back(envLight);
        }

        void SimpleScene::addLight(Light::Ptr light) {
            ASSERT(light != nullptr, "Added light can't be nullptr. ")
            _lights.push_back(light);
        }

        std::shared_ptr<Camera> SimpleScene::getCamera() {
            return _camera;
        }

        const std::vector<std::shared_ptr<Light>> &SimpleScene::getLights() const {
            return _lights;
        }

        void SimpleScene::setCamera(std::shared_ptr<Camera> camera) {
            _camera = camera;
        }

        bool SimpleScene::intersect(Ray &ray, SurfaceInteraction &si) const {
            return _world->intersect(ray, si, ray.getMinStep(), ray.getStep());
        }

        bool SimpleScene::intersectWithMedium(Ray &ray, SurfaceInteraction &si, core::Spectrum &transmittance,
