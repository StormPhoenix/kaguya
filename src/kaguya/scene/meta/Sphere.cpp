...
namespace kaguya {
    namespace scene {
        ...
        bool Sphere::insect(Ray &ray, SurfaceInteraction &si, double stepMin, double stepMax) const {
        ...
        SurfaceInteraction Sphere::sampleSurfaceInteraction(const Interaction &eye, const Sampler1D *sampler1D) const {
