...
namespace kaguya {
    namespace scene {
        ...
        void Box::buildBox() {
            ...
            // TODO UV
            std::shared_ptr<Shape> tri1 = std::make_shared<Triangle>(a5, a4, a1,
            ...
            objects.push_back(gt1);

            std::shared_ptr<Shape> tri2 = std::make_shared<Triangle>(a5, a8, a4,
                                                                     n_left, n_left, n_left,
                                                                     default_uv, default_uv, default_uv,
                                                                     _transform);
